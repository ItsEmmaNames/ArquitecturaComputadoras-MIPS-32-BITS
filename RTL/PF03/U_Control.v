...
always@(*) begin 
    ...
    memToWrite = 1'b0; memToReg = 1'b0; Jump = 1'b0; Bne = 1'b0;
    ...
    case (op)
        ...
        6'b000101: begin
            ...
            Branch = 1'b1;
            Bne = 1'b1;
            AluOP = 3'b110;  // MODIFICADO: Código especial para BNE
        end

        // ADDI 
        6'b001000: begin     // MODIFICADO: Opcode correcto de ADDI
            RegDst = 1'b0; 
            ALUSrc = 1'b1; 
            RegWrite = 1'b1; 
            AluOP = 3'b000; // SUMA
        ...
        // SUBI (Opcode no estandar asignado)
        6'b001001: begin
            RegDst = 1'b0; 
            ALUSrc = 1'b1; 
            RegWrite = 1'b1; 
        ...
        //TIPO J
        6'b000010: begin
            Jump = 1'b1;     // Activa la señal de salto incondicional
        end
    endcase 
end
endmodule