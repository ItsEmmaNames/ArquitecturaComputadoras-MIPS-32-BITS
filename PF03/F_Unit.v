module Forwarding_Unit(
    ...
    input exmem_RegWrite,         // ¿La instrucción en MEM va a escribir en registros?
    input memwb_RegWrite,         // ¿La instrucción en WB va a escribir en registros?
    ...
    always @* begin
        ...
        // ==========================================
        // RIESGOS EN LA ETAPA EX (Prioridad Alta)
        // ==========================================
