module DPTR (
    ...
    input [31:0] pc4_in,           // <--- NUEVO: Recibe PC+4 de la etapa ID
    output [31:0] result,
    
    output Branch_out,
    output Zero_out,
    output [31:0] SignExt_out,
    output [31:0] PC4_Branch_out,  // <--- NUEVO: Exporta PC+4 desde la etapa EX
    ...
    // ==========================================
    // SEÑALES MODIFICADAS: Evaluar el salto en la etapa EX
    // ==========================================
